...
- anthology と archiving のメディアブロックで画幅比率を選択可能：3:2(135)、2:3(Half)、2.7:1(X-Pan)、4:3(6x4.5)、1:1(6x6)、1.16:1(6x7)、1.37:1(6x8)、2.25:1(6x12)、3:1(6x17)、5:4(4x5) などのフィルム画幅をサポートし、フロントエンドは画幅に応じて画像の回転とセル比率を制御
