...
- anthology と archiving のメディアブロックで「画幅/表示方式」を選択可能：フィルム画幅比率（3:2/135、2:3/Half、2.7:1/X-Pan、4:3/6x4.5、1:1/6x6、1.16:1/6x7、1.37:1/6x8、2.25:1/6x12、3:1/6x17、5:4/4x5）と表示方式（シングル single、ディプティク diptych、フォトウォール wall、レポート report）の2つの次元をサポートし、フロントエンドは画幅に応じて画像の回転とセル比率を制御し、表示方式に従ってレンダリング；他の表示タイプは対応する表示方式に固定で選択不可
