...
- anthology 和 archiving 媒體區塊可選「畫幅/展示方式」：支援底片畫幅比例（3:2/135、2:3/Half、2.7:1/X-Pan、4:3/6x4.5、1:1/6x6、1.16:1/6x7、1.37:1/6x8、2.25:1/6x12、3:1/6x17、5:4/4x5）與展示方式（單幅瀑布流 single、雙聯畫 diptych、照片牆 wall、報告 report）兩種維度，前台根據畫幅控制圖片旋轉和畫格比例，按展示方式渲染；其他展示類型固定為對應的展示方式且不可選
