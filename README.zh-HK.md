...
- Lightbox 大圖查看：所有展示模式（single/diptych/wall/report/anthology）點擊圖片彈出 Lightbox 大圖，不再跳轉新頁面；支持左右切換、鍵盤導航（Esc 關閉、← → 切換）、點擊遮罩關閉；雙聯畫模式同時展示一對圖片，移動端自動上下堆疊；底部展示作品闡述（Markdown 渲染）
